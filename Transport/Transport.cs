...
namespace Transportlaget
{
    ...
    public class Transport
    {
        ...
        {           
            ...
            do
            {
                bytesRead = link.receive(ref buffer);
                var checksumCheck = checksum.checkChecksum(buffer, bytesRead);
                checkSumState = checksumCheck && buffer[(int)TransCHKSUM.SEQNO] != old_seqNo;
